...
private:
   ...
   /* =================== private helper function declarations ======= */
    ...
    void pruneTree(Node* nd, double tol);
    bool withinTolerance(Node* toCompareTo, Node* node, double tol);
    void clearChild(Node* child);
    void renderPicture(Node* nd, PNG pic);
    // Node* copyTree(Node*orig);
